...
You can use [news_process.ipynb](DataAnalyzing/NLPExperiment/news_process.ipynb) to run T5 and Bert models on news sentiment classification tasks.  Since the dataset is too large, we only contain the news data of APPLE in [stock_news](DataAnalyzing/NLPExperiment/stock_news) folder.

To get more dataset of NLP experiments, run [NLPdataset.py](DataCollection/NLPdataset.py) .
